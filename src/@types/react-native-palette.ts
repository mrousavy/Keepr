declare module 'react-native-palette' {
  ...
  export type NamedSwatchesCallback = (
    error: Error,
    swatches: NamedSwatches,
  ) => void;

  export function getAllSwatches(
    options: Options,
    image: string,
    callback: AllSwatchesCallback,
  ): void;

  export function getNamedSwatches(
    image: string,
    callback: NamedSwatchesCallback,
  ): void;
}
